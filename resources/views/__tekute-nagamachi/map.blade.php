...
<title>tekuteながまち フロアMAP｜JR東日本東北総合サービス株式会社</title>
...
<script>
  ...
  map.setMaxBounds(new L.LatLngBounds([0,3900], [1824,0]));
  var imageUrl = '/serviceinfo/assets/img/tekute-nagamachi/map01.jpg';
