...
<title>福島駅西口パワーシティピボット フロアMAP｜JR東日本東北総合サービス株式会社</title>
...
<script>
  ...
  map.setMaxBounds(new L.LatLngBounds([0,2982], [1707,0]));
  var imageUrl = '/serviceinfo/assets/img/pivot/fukushima_map.jpg';
  var imageBounds = [[1707,0], [0,2982]];
