...
<title>会津若松駅食品館ピボット フロアMAP｜JR東日本東北総合サービス株式会社</title>
...
<script>
  ...
  map.setMaxBounds(new L.LatLngBounds([0,2739], [1475,0]));
  var imageUrl = '/serviceinfo/assets/img/pivot/aizuwakamatsu_map.gif';
  var imageBounds = [[1475,0], [0,2739]];
