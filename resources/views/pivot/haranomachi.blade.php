...
<title>クオリティフードストア仙台原ノ町Pivot｜JR東日本東北総合サービス株式会社【LiViT】</title>
<meta name="description" content="JR陸前原ノ町駅のすぐ隣、新鮮な魚介で人気の「仙令平庄」をはじめとした生鮮食品を扱う専門店が揃っております。普段使いの商品はもちろん、ハレの日のごちそうなど専門店ならではの新鮮でおいしい、安全安心な商品をお客さまへご提供いたします。">
<meta name="keywords" content="仙台,原ノ町,駅,ショッピング,スーパー,買い物,生鮮,食料品,日用品,弁当,惣菜,サービス,ピボット,Pivot,ショップ,店舗情報">
<meta property="og:title" content="クオリティフードストア仙台原ノ町Pivot｜JR東日本東北総合サービス株式会社【LiViT】">
<meta property="og:description" content="JR陸前原ノ町駅のすぐ隣、新鮮な魚介で人気の「仙令平庄」をはじめとした生鮮食品を扱う専門店が揃っております。普段使いの商品はもちろん、ハレの日のごちそうなど専門店ならではの新鮮でおいしい、安全安心な商品をお客さまへご提供いたします。">
				...
				<div class="breadcrumbs">
								...
								<div class="js-fixed-nav">
											<button class="js-fixed-close">
											  ...
											  <ul class="sns">
												<li class="insta"><a href="https://www.instagram.com/haranomachipv/" target="_blank"><img src="/serviceinfo/assets/img/common/btn_insta.png" width="100%" alt=""><span class="text">pivot<br class="sp">公式インスタグラム<br>お得な情報配信中！</span></a></li>
												<li class="line"><a href="https://page.line.me/wym3071g" target="_blank"><img src="/serviceinfo/assets/img/common/btn_line.png" width="100%" alt=""><span class="text">pivot<br class="sp">公式LINE<br>お得な情報配信中！</span></a></li>
										  </ul>
										</div>
						</div>
						<div class="tpl_contents">
								<section class="mainVisual">
										<div class="inner">
												<div class="main"><img src="/serviceinfo/assets/img/pivot/main01_pc.jpg" class="pc" alt=""><img src="/serviceinfo/assets/img/pivot/main01_sp.jpg" class="sp" alt=""></div>
												<div class="headTtl">
														<dl>
																<dt>JR陸前原ノ町駅隣接</dt>
																<dd>クオリティフードストア<br>
												...
												<p class="lead">JR陸前原ノ町駅のすぐ隣、新鮮な魚介で人気の「仙令平庄」をはじめとした<br class="pc">
														生鮮食品を扱う専門店が揃っております。普段使いの商品はもちろん、ハレの日のごちそうなど専門店ならではの<br class="pc">
														新鮮でおいしい、安全安心な商品をお客さまへご提供いたします。</p>
								...
								<ul class="anchor">
									<li><a href="https://www.livit.jregroup.ne.jp/pivot/search?pt%5B%5D=53&ot%5B%5D=82&keywords=">ショップ一覧</a></li>
                                ...
                                <section class="recommend">
                                  ...
                                  <div class="osusume sp"><iframe width="300" height="250" title="ピボット 仙台原ノ町店のチラシ・特売情報" src="https://widgets.tokubai.co.jp/21946/widget?height=250&width=300" frameborder="0"><a href="https://widgets.tokubai.co.jp/21946/widget?height=250&width=300">ピボット 仙台原ノ町店のチラシ・特売情報</a></iframe></div>
                                  <ul class="bgItem">
                                    <li class="item07"></li>
                                  </ul>
								  <div class="bnr"><a href="https://www.instagram.com/haranomachipv/" target="_blank"><img src="/serviceinfo/assets/img/pivot/bnr_pivot_pc_01.png" class="pc" alt=""><img src="/serviceinfo/assets/img/pivot/bnr_pivot_sp_01.png" class="sp" alt=""></a></div>
                                </section>
								...
								<!-- <section class="event">
										<div class="inner">
												...
												<div class="calender">
														...
														<iframe src="https://calendar.google.com/calendar/embed?src=pivotharanomachi%40gmail.com&ctz=Asia%2FTokyo&showTitle=0&showTabs=0" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
														</div>
												</div>
												<ul class="bgItem">
								...
								<section class="shopinfo" id="information">
										<div class="inner">
												...
												<div class="shopdata">
														<h3 class="name">クォリティフードストア　<br class="sp">仙台原ノ町Pivot</h3>
														<div class="photo"><img src="/serviceinfo/assets/img/pivot/haranomachi_img.jpg" width="100%" alt=""></div>
														<table>
																<tr class="time">
																		<th>営業時間</th>
																...
																<tr>
																		<th>電話番号</th>
																		<td class="telLink">022-292-3722</td>
																</tr>
																<tr>
																		<th>住所</th>
																		<td>〒983-0842　宮城県仙台市宮城野区五輪2-12-55
																				<div class="btn_map"><a href="https://goo.gl/maps/jUNz8WHVuPD2" target="_blank">MAP</a></div></td>
																</tr>
																<tr>
																		<th>アクセス</th>
																		<td>JR陸前原ノ町駅（仙石線）から徒歩３分</td>
																</tr>
														</table>
												</div>
												<div class="shopbox">
														...
														<div class="box" id="box02">
																...
																<ul class="sns">
																	<li class="insta"><a href="https://www.instagram.com/haranomachipv/" target="_blank"><img src="/serviceinfo/assets/img/common/btn_insta.png" width="35" alt=""></a></li>
																	<li class="line"><a href="https://page.line.me/wym3071g" target="_blank"><img src="/serviceinfo/assets/img/common/btn_line.png" width="35" alt=""></a></li>
																  </ul>
														</div>
												</div>
												<ul class="bgItem">
								...
								<div class="jrebnr">
										...
										<dl>
												<dt>「仙台原ノ町Pivot｣での<br class="sp">お買いものがJRE POINTカードで<br class="sp">もっとおトク！</dt>
												<dd>
