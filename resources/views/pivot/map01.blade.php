...
<title>クオリティフードストア仙台原ノ町ピボット フロアMAP｜JR東日本東北総合サービス株式会社</title>
...
<script>
  ...
  map.setMaxBounds(new L.LatLngBounds([0,4106], [1739,0]));
  var imageUrl = '/serviceinfo/assets/img/pivot/haranomachi_map.gif';
  var imageBounds = [[1739,0], [0,4106]];
