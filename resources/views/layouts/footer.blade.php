								...
								<ul class="tpl_rowList">
										...
										<div class="tpl_acdn">
											...
											<div class="tpl_acdnPanel">
												<ul class="tpl_fatList">
													...
													<li><a href="{{ route('search') }}?tag_names={{ urlencode('いろといろ') }}">東北めぐり いろといろ</a></li>
									...
									<li class="tpl_list02">
										<div class="tpl_acdn">
											...
											<div class="tpl_acdnPanel">
												<ul class="tpl_fatList">
													<li><a href="{{ route('tekute-top') }}">tekute</a></li>
													<li class="tpl_subLink"><a href="{{ route('tekute-sendai') }}"><span>tekuteせんだい</span></a></li>
													<li class="tpl_subLink"><a href="{{ route('tekute-nagamachi') }}"><span>tekuteながまち</span></a></li>
													<li class="tpl_subLink"><a href="{{ route('sub-search', config('livit.static_tag_names.tekute_tagajo')) }}"><span>tekuteたがじょう</span></a></li>
													<li class="tpl_subLink"><a href="{{ route('sub-search', config('livit.static_tag_names.tekute_honshiogama')) }}"><span>tekuteほんしおがま</span></a></li>
													<li><a href="{{ route('pivot-top') }}">Pivot</a></li>
													<li class="tpl_subLink"><a href="{{ route('pivot-haranomachi') }}"><span>クオリティフードストア 仙台原ノ町ピボット</span></a></li>
													<li class="tpl_subLink"><a href="{{ route('pivot-koriyama') }}"><span>郡山駅食品館ピボット</span></a></li>
													<li class="tpl_subLink"><a href="{{ route('pivot-aizuwakamatsu') }}"><span>会津若松駅食品館ピボット</span></a></li>
													<li class="tpl_subLink"><a href="{{ route('pivot-fukushima') }}"><span>福島駅西口パワーシティピボット</span></a></li>
												</ul>
												<ul class="tpl_fatList">
													<li><a href="{{ route('sub-search', config('livit.static_tag_names.seagull')) }}">シーガルタウン本八戸</a></li>
													<!-- <li><a href="{{ route('sub-search', config('livit.static_tag_names.market')) }}">秋田市保戸野</a></li> -->
									...
									<li class="tpl_list03">
										<div class="tpl_acdn">
											...
											<div class="tpl_acdnPanel">
												<ul class="tpl_fatList">
													<li><a href="{{ route('transit-advertising') }}"><span>JR東日本交通広告</span></a></li>
													<li><a href="{{ route('tenant') }}"><span>出店募集のご案内</span></a></li>
												</ul>
											</div>
										</div>
									</li>
