                                ...
                                @if ($place_tags)
                                  <div class="unit unit01 arrow">
                                    <dl class="row">
  	                                  ...
  	                                  <dd>
  	                                    <div class="acBox">
  		                                  <ul class="acList wideList">
                                            @php $idx = 1 @endphp
                                            @foreach ($place_tags as $tag)
  			                                  <li><input id="s{{ $idx }}" name="pt[]" type="checkbox" value="{{ $tag->id }}" @if(in_array($tag->id, $selected_tag_ids)) checked @endif ><label for="s{{ $idx }}" class="btn {{ $tag-> class }}">{{ format_tekute_shop($tag->name) }}</label></li>
                                                                                @php $idx++ @endphp
                                            @endforeach
  		                                  </ul>
  	                                    </div>
