@foreach ($contents as $content)
  <li>
	<a href="{{ route('detail', $content->content_id)  }}" class="btn">
      ...
      <p class="ttl">{{ $content->shop_genre ? $content->shop_genre : '' }}</p>
      <div class="desc"><p>{!! $content->business_hours !!}</p></div>
      {{-- <p class="ttl">{{ $content->title }} / ジャンル</p>
      <div class="desc"><p>営業時間</p></div> --}}
	</a>
  </li>
@endforeach
