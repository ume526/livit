...
$(function(){
	...
	$('.tpl_header .tpl_gNav .tpl_dropdown .tpl_navBtn').on('touchstart',function(){
		if(!$(this).parent('.tpl_dropdown').hasClass('tpl_gOn')){
			$(this).parent('.tpl_dropdown').addClass('tpl_gOn');
			$(this).parent('.tpl_dropdown').removeClass('tpl_gOff');
		}else{
			$(this).parent('.tpl_dropdown').removeClass('tpl_gOn');
			$(this).parent('.tpl_dropdown').addClass('tpl_gOff');
		}
	});
